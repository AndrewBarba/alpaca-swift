...
extension AlpacaClient {
    public func portfolioHistory(period: String? = nil, timeframe: Models.PortfolioHistory.Timeframe? = nil, dateEnd: Date? = nil, extendedHours: Bool? = nil) -> ResponsePublisher<Models.PortfolioHistory> {
