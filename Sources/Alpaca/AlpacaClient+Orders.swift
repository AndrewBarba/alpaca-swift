...
extension AlpacaClient {
    public func orders(status: String? = nil, limit: Int? = nil, after: Date? = nil, until: Date? = nil, direction: Models.SortDirection? = nil, nested: Bool? = nil) -> ResponsePublisher<[Models.Order]> {
    ...
    public func order(id: UUID, nested: Bool? = nil) -> ResponsePublisher<Models.Order> {
        return get("orders/\(id)", searchParams: ["nested": nested.map(String.init)])
    }

    public func order(id: String, nested: Bool? = nil) -> ResponsePublisher<Models.Order> {
        return get("orders/\(id)", searchParams: ["nested": nested.map(String.init)])
    }

    public func createOrder(symbol: String, qty: Double, side: Models.Order.Side, type: Models.Order.OrderType, timeInForce: Models.Order.TimeInForce, limitPrice: Double? = nil, stopPrice: Double? = nil, extendedHours: Bool = false, `class`: Models.Order.Class? = nil, takeProfitLimitPrice: Double? = nil, stopLoss: (stopPrice: Double, limitPrice: Double?)? = nil) -> ResponsePublisher<Models.Order> {
